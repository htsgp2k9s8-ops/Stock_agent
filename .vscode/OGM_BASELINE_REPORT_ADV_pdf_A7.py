...
def skeniraj_trg():
    ...
    for krog, ticker in enumerate(tickerji_v_obdelavi, 1):
        ...
        try:
            ...
            if zadnji_ma200_weekly == 0: continue
...
def generiraj_html_porocilo(podatki):
    ...
    <div class="header">
        ...
        <p id="navodilo-klik" style="font-size: 9pt; color: #93c5fd; margin-top: 5px;">* Sistem daje absolutno prednost nakupom vrhunskih podjetij v coni ugodnosti tik nad dolgoročnim 200w MA. Klikni na ticker za analizo OGM in sezonskosti.</p>
