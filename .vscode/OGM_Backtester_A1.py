...
print("=========================================================")
print("🚀 OGM PORTFOLIO BACKTESTER - Z MEGA-CAP PRAVILOM (V3)")
print("=========================================================")
...
for ticker in vsi_tickerji:
    try:
        ...
        t_mar = np.interp(margin_pct, [25, 35, 45, 55, 65], [0.0, 2.0, 5.0, 8.0, 10.0])        # Max 10 (popravljeno!)
...
# ==============================================================================
print("Kalkuliram OGM Buy in Sell točkovnike (z V3 Mega-Cap pravilom)...")
signali = {}
...
for ticker in veljavni_tickerji.keys():
    ...
    if is_mega_cap:
        # MEGA-CAP PRAVILO V3 (Strogi pullback zaklep)
...
<div class="header">
    ...
    <p>Začetni kapital: 100.000 € | Max 5% na delnico | V3 Mag7 Odklep Padajočih Nožev</p>
