...
def skeniraj_trg():
    ...
    for krog, ticker in enumerate(tickerji_v_obdelavi, 1):
        ...
        try:
            ...
            if is_mega_cap:
                # V3 STROGI POGOJ: Nad 15% dobi 0 točk! Biti mora res blizu 50w MA.
            ...
            trenutni_ogm = min(100.0, float(ogm_zgodovina[-1])) # DVOJNA VAROVALKA!
            ...
            strong_buy_podatki_za_graf[ticker] = {
                ...
                "components": {
                    ...
                    "total_score": float(trenutni_ogm), # TU BO ZDAJ ZAGOTOVO MAX 100
                    "ma_type": tip_ma
                }
            }
...
# ==============================================================================
# 3. HTML GENERATOR POROČILA (Brez sprememb v designu)
# ==============================================================================
